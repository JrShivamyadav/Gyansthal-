...
public class FacultyAddpyq extends HttpServlet {
                      ...
                      if(part.isParam()){
                       ...
                       if(fileName != null){
                          long fileSize = filePart.writeTo(new java.io.File("C:\\Users\\shiva\\OneDrive\\Desktop\\RMLAU gyansthal\\RmlauGynSthalOpt\\web\\pdf")); 
                                         ...
                                         db.pstmt = db.con.prepareStatement("INSERT INTO data(year,sem,branch,description,ctype,content,date) VALUES (?,?,?,?,'Pyq',?,curdate())");
                                         ...
                                         if(i1 >0){
                                            out.println("<script>alert('Pyq Added SuccessFully');</script>");                                                                                                                                                           
                                          response.sendRedirect("Faculty/FacultyPyqmgmt.jsp");
                                         }
