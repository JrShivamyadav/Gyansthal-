...
public class AdminAddeNoews extends HttpServlet {
                      ...
                      if(part.isParam()){
                       ...
                       if(fileName != null){
                          long fileSize = filePart.writeTo(new java.io.File("C:\\Users\\shiva\\OneDrive\\Desktop\\RMLAU gyansthal\\RmlauGynSthalOpt\\web\\pdf")); 
                                         ...
                                         db.pstmt = db.con.prepareStatement("INSERT INTO news(uploadedby,email,date,news,file) VALUES (?,?,curdate(),?,? )");
                                         ...
                                         if(i1 >0){
                                          out.println("<script>alert('Notes Added SuccessFully');</script>");                                                                                                                                                           
                                          response.sendRedirect("Admin/AdminAddNews.jsp?msg=data added successfuly");
                                         }
