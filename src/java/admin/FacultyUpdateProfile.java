...
public class FacultyUpdateProfile extends HttpServlet {
                       ...
                       if(fileName != null){
                          long fileSize = filePart.writeTo(new java.io.File("C:\\Users\\shiva\\OneDrive\\Desktop\\RMLAU gyansthal\\RmlauGynSthalOpt\\web\\img")); 
                                        ...
                                        String email = value[3];
                                         ...
                                         db.pstmt = db.con.prepareStatement("Update faculty_detail set salutation=?,name=?, branch=?,contact=?,spec=?,post=?,images=? where email=?");
                                       
                                         db.pstmt.setString(1, value[0]);
                                         db.pstmt.setString(2, value[1]);
                                         db.pstmt.setString(3, value[2]);
                                         db.pstmt.setString(4, value[4]);
                                         db.pstmt.setString(5, value[5]);
                                         db.pstmt.setString(6, value[6]);
                                         ...
                                         if(i1 >0){
                                          ...
                                          response.sendRedirect("Faculty/FacultyViewProfile.jsp");
                                         }
