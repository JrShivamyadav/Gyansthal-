...
public class FacultyAddProfile extends HttpServlet {
                      ...
                      if(part.isParam()){
                       ...
                       if(fileName != null){
                          long fileSize = filePart.writeTo(new java.io.File("C:\\Users\\shiva\\OneDrive\\Desktop\\RMLAU gyansthal\\RmlauGynSthalOpt\\web\\img")); 
                                         ...
                                         db.pstmt = db.con.prepareStatement("INSERT INTO faculty_detail(salutation,name,branch,email,contact,spec,post,status,qual,areainterest,images) VALUES (?,?,?,?,?,?,?,'1',?,?,?)");
                                         ...
                                         db.pstmt.setString(10,(fileName));
