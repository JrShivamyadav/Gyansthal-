...
public class FacultyAddecontent extends HttpServlet {
                      ...
                      if(part.isParam()){
                       ...
                       if(fileName != null){
                          long fileSize = filePart.writeTo(new java.io.File("C:\\Users\\shiva\\OneDrive\\Desktop\\RMLAU gyansthal\\RmlauGynSthalOpt\\web\\pdf")); 
                                         ...
                                         db.pstmt = db.con.prepareStatement("INSERT INTO data(year,sem,branch,description,ctype,content,date) VALUES (?,?,?,?,'EContent',?,curdate())");
                                        ...
                                        // db.pstmt.setString(5, value[4]);
                                         ...
                                         if(i1 >0){
                                          ...
                                          response.sendRedirect("Faculty/FacultyEcontentsmgmt.jsp");
