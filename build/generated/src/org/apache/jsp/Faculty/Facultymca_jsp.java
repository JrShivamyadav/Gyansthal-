...
public final class Facultymca_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("      <h1>Department of MCA</h1>\n");
      out.write("       <div class=\"container CSEcontent\">\n");
      out.write("        <div class=\"col-sm-6 \">\n");
      out.write("          <p>The Department of MCA offers Master's programme, and the number of students intake is 60 every year. The success rate at examinations and Respectively and employment are fairly impressive in the present scenario. The thrust areas of the Department included Computer Networking, Fault Tolerance, Software Engineering, Database, Computer Architecture. The major focus of the Department in teaching and research has been on Networking, Database and Software Engineering. The Department has Computers and various licensed software?s. There is a plan of action to achieve the aims \n");
      ...
      out.write("              ");
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master of Computer Application' and status='1' order by name ");
