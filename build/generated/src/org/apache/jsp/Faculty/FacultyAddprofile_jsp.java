...
public final class FacultyAddprofile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
     ...
     String email = ""+session.getAttribute("facultyemail");
      ...
      out.write("                        <h4 class=\"page-title\" style=\"color:red;text-shadow: 5px 0px 4px gray;font-size:35px;font-weight:bold;font-family: Gabriola\">ADD PROFILE</h4> </div>\n");
      out.write("                    <div class=\"col-lg-9 col-sm-8 col-md-8 col-xs-12\">\n");
      out.write("                        <button type=\"submit\" style=\"background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;\"><a href=\"FacultyViewProfile.jsp\" style=\"color: white;text-decoration: none;font-size: 15px;font-weight: bold;\">View Profile</a></button>\n");
      out.write("                    </div>\n");
      out.write("                    <!-- /.col-lg-12 -->\n");
      out.write("                </div>\n");
      out.write("              \n");
      ...
      out.write("\t\t\t\t  <h4 style=\"text-align:center;font-size:50px;font-weight:bold;color:red;font-family:Gabriola;margin-top:50px\">Add Details</h4>\n");
      out.write("                                  <form action=\"../FacultyAddProfile\" method=\"post\" enctype=\"multipart/form-data\">\n");
      out.write("\t\t\t\t  <div class=\"col-md-12\" style=\"font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola\">\n");
      out.write("\t\t\t\t\n");
      out.write("                       Salutation <select required class=\"form-control\" name=\"sal\" style=\"border-bottom:2px solid red;background:none;font-size:25px\">\n");
      out.write("                           <option>Mr.</option>\n");
      out.write("                           <option>Mr.</option>\n");
      out.write("                           <option>Mrs.</option>\n");
      out.write("                           <option>Miss.</option>\n");
      out.write("                           <option>Er.</option>\n");
      out.write("                           <option>Dr.</option>\n");
      out.write("                       </select>\n");
      out.write("\t\t\t\t\t<br />  \n");
      out.write("                                        \n");
      out.write("                        Enter Name <input type=\"Text\" required class=\"form-control\" name=\"name\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />  \n");
      out.write("                               Select Branch <select  required class=\"form-control\" name=\"dept\" style=\"border-bottom:2px solid red;background:none;font-size:25px\">\n");
      ...
      out.write("\t\t\t\t\t<br />          \n");
      out.write("                                           \n");
      out.write("                        Enter Email <input type=\"hidden\"  class=\"form-control\" name=\"email\"  value=\"");
      out.print(email );
      out.write("\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />\n");
      out.write("                                                    \n");
      out.write("\t\t\tEnter Mobile No.<input type=\"number\" required class=\"form-control\" name=\"mob\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />\n");
      out.write("                                        \n");
      out.write("                         \n");
      out.write("                                      \n");
      out.write("                        Enter Specialization<input type=\"Text\" required class=\"form-control\" name=\"spec\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />\n");
      out.write("                         Enter Designation <select required class=\"form-control\" name=\"post\" style=\"border-bottom:2px solid red;background:none;font-size:25px\">\n");
      out.write("                             <option>Select Designation</option>\n");
      out.write("                             <option>Vice Chancellor</option>\n");
      out.write("                         <option>Director</option>\n");
      out.write("                         <option>Professor</option>\n");
      out.write("                         <option>Asst.Professor</option>\n");
      out.write("                        \n");
      out.write("                         </select>\n");
      out.write("\t\t\t\t\t<br /> \n");
      out.write("                                    \t\t\t\t\n");
      out.write("\t\t\tUpload profile Pic\t<input type=\"file\" required class=\"form-control\" name=\"file\" style=\"border-bottom:2px solid red;background:none;font-size:20px\"/>\n");
      out.write("\t\t\t\t\t<br />\n");
      out.write("\t\t\tEnter Qualification<input type=\"Text\" required class=\"form-control\" name=\"qual\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />\t\n");
      out.write("                        Enter Area Of Interest<input type=\"Text\" required class=\"form-control\" name=\"area\" style=\"border-bottom:2px solid red;background:none;font-size:25px\"/>\n");
      out.write("\t\t\t\t\t<br />               \n");
