...
public final class MComputerS_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <a href=\"Mindex.jsp\"><img src=\"../img/lohialogo.jpg\" style='height:100px;width:100px;border-radius:30px; '/></a>\n");
      out.write("            <hr/>\n");
      out.write("              <a href=\"MComputerS.jsp\"><i class=\"fa fa-users\" aria-hidden=\"true\"></i>&nbsp;&nbsp; Faculty</a>\n");
      ...
      out.write("          <p>The Department of Computer Science offers B.Tech. programme, and the number of students intake is 60 every year. The success rate at examinations and Respectively and employment are fairly impressive in the present scenario. The thrust areas of the Department included Computer Networking, Fault Tolerance, Software Engineering, Database, Computer Architecture. The major focus of the Department in teaching and research has been on Networking, Database and Software Engineering. The Department has Computers and various licensed software?s. There is a plan of action to achieve the aims \n");
