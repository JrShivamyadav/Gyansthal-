            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyAddpyq.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Add PYQ</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                   ...
                   <th>Description</th>  <th>File</th><th>Date</th><th>View</th> <th>Delete</th></tr>    
                    ...
                    <%
                      try{
                          ...
                          db.pstmt = db.con.prepareStatement("select * from data where ctype='Pyq' order by date");
                          ...
                          while(db.rst.next()){
                            ...
                            out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td>"
                                    ...
                                    + "<button><a href=Facultydeletepyq.jsp?date="+db.rst.getString(7)+"&desc1="+udesc+"&fname="+ufname+"&>Delete</a> </button></td></tr>");
                          }
