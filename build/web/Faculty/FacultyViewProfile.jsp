...
<div class="split left">
    Name : <span style="color:blue;"><%=db.rst.getString(1)  %> <%=db.rst.getString(2)  %> </span><br>
    Designation :<span style="color:blue;">  <%=db.rst.getString(7)  %></span> <br>
     Specialization :<span style="color:blue;">  <%=db.rst.getString(6)  %></span><br>
        Department : <span style="color:blue;"> <%=db.rst.getString(3)  %> </span><br>
        Area Of Interest :<span style="color:blue;">  <%=db.rst.getString(6)  %></span><br>
        Email : <span style="color:blue;"><%=db.rst.getString(4)  %> </span><br>
        Mobile No : <span style="color:blue;"> <%=db.rst.getString(5)  %></span><br>
        
</div>

<div class="split right">
    <img src="../img/<%=db.rst.getString(9) %>" class="imgg" ><br><br><br>
    
    <button class="b11"><a style="color:white;" href="FacultyUpdateProfile.jsp">Update</a></button>
</div>
...
<%
                             ...
                             out.println("<br><br><br><br><br><h1 style='margin-left:20%;'>Please Add Profile First. Data Not Found!!!!!!!!!</h1>");
                              out.println("<br><br><br><button class='b11' ><a style='color:white; ' href='FacultyAddprofile.jsp' >Add Profile</a> </button>");
                         }
                      }catch(Exception e){
                          e.printStackTrace();
                      }
