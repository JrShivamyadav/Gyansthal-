<%@include file="FacultyDashStruct.jsp" %>
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
				  ...
				  <div class="col-md-6">
				  <h4 style="text-align:center;font-size:50px;font-weight:bold;color:red;text-shadow: 5px 0px 4px gray;font-family:Gabriola;margin-top:50px">Add Syllabus</h4>
				  <form action="../FacultyAddsyllabus" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
				 Enter Year <select type="number" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px">
                                      <option>Select Year</option>  <option>2023-24</option><option>2024-25</option><option>2025-26</option><option>2026-27</option>
					...
					<br />
                              ...
                              Enter Branch      <select type="text" required class="form-control" name="branch"style="border-bottom:2px solid red;background:none;font-size:15px">
      ...
      <option>UG Diploma in German</option>
			...
			Mention Syllabus Description<input type="text" required class="form-control" name="desc"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
