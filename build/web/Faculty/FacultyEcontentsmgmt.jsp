            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyAddecontent.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Add Econtent</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                         ...
                         int count=1;
                          ...
                          while(db.rst.next()){
                            ...
                            out.println("<tr><td>"+count+"</td><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td><td>"+db.rst.getString(4)+"</td>"
                                    ...
                                    + "<button><a href=Facultydeleteecontent.jsp?desc="+udesc+"&date="+db.rst.getString(7)+">Delete</a> </button></td></tr>");
                            count++;
                          }
