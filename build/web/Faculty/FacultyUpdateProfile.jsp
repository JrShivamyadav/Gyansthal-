...
<!--				  <h4 style="text-align:center;font-size:50px;font-weight:bold;color:maroon;font-family:Gabriola;margin-top:50px"></h4>-->
                                  <center> <img src="../img/<%=db.rst.getString(9) %>" style=" height:200px;width:200px;border-radius:50%; "></center>
                                  <form action="../FacultyUpdateProfile" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
				
                                      
                                      Salutation <input type="Text" value="<%=db.rst.getString(1)  %>" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br /> 
                                        
                       Name <input type="Text" value="<%=db.rst.getString(2)  %>" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />  
                                      
                                       
                        Department <select type="Text"  required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px">
      ...
      <option>UG Diploma in German</option>
                 ...
                 <input type="hidden" value="<%=db.rst.getString(4) %>" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px"/>
				
                                        
                       Mobile No. <input type="number" value="<%=db.rst.getString(5)  %>" required class="form-control" name="branch"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
                                                    
		Specialization<input type="text" value="<%=db.rst.getString(6)  %>" required class="form-control" name="desc"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
                            Designation <input type="text" value="<%=db.rst.getString(7)  %>" required class="form-control" name="desc"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
                                        
			Upload New profile Pic	<input type="file" value="<%=db.rst.getString(9)  %>" required class="form-control" name="file" style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
