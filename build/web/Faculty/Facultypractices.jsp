                            ...
                            <div class="navbar-header">
                              ...
                              <!-- Collect the nav links, forms, and other content for toggling -->
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                            <li><a href="Facultyindex.jsp"><span>Home</span></a></li>
                                            <li><a href="facultyaboutus.jsp" ><span>About us</span></a></li>
                                            ...
                                            <li><a href="Facultypractices.jsp" ><span>Practice</span></a></li>
                                            <li><a href="FacultyQuizmgmt.jsp" ><span>Quizes</span></a></li>
                                             <li><a href="Facultycontact.jsp" ><span>Contactus</span></a></li>
                                            <li><a href="Facultydiscussionf.jsp" ><span>Discussion</span></a></li>
                                            <li>
...
<h1 style="font-size:65px;font-family: Gabriola;text-align:center;color:red;font-weight:bold;margin-top:40px;text-shadow: 5px 0px 4px gray;"><u>Practice</u></h1>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/htmlpractice.jsp" target="_blank" style="color:maroon !important;">HTML&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/htmlpractice.jsp" target="_blank" style="color:maroon !important;">CSS&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/javascriptpractice.jsp" target="_blank" style="color:maroon !important;">JavaScript&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/jquerypractice.jsp" target="_blank"  style="color:maroon !important;">jQuery&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/phppractice.jsp" target="_blank"  style="color:maroon !important;">html&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
            ...
            <div class="box">
                ...
                <div class="content">
                    <h3><a href="../JSPcode/bootstrappractice.jsp" target="_blank"  style="color:maroon !important;">BootStrap&nbsp;<i class="fa fa-edit" style="font-size:20px"></i></a></h3>
