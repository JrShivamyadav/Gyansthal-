...
%> 
				  ...
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
					...
					<br /> 
                                          ...
                                          Branch <select type="text" required class="form-control" name="branch"  value="<%=db.rst.getString(4)  %>" style="border-bottom:2px solid red;background:none;font-size:25px">
