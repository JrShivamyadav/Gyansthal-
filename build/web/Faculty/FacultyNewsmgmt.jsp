            ...
            <div class="container-fluid">
                ...
                <!-- .row -->
				 <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyAddNews.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Add News</a></button>
                    <!-- /.col-lg-12 -->
                </div>
				  ...
				  <table class="table table-responsive" style="background:white">
                          ...
                          <%
                              try{
                                ...
                                db.pstmt = db.con.prepareStatement("SELECT DISTINCT * from news where email=? order by date desc;");
                       ...
                       out.println("<tr><td>"+count+"</td><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(3)+"</td>"
                               ...
                               + "<td><button><a href=Facultydeletenews.jsp?news="+encodedNews+"&date="+date+">Delete</a> </button></td>");
