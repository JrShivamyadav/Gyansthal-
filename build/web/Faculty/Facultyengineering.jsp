...
<div class="row ">
        ...
        <div class="col-sm-8 crshead">
            <div class="row text-center">
                <span>Departmemnt Of Engineering</span>
            </div>
        </div>
        <div class="col-sm-2"></div>
    </div>
    ...
    <div class="col-sm-5 tabs">
      <a href="FacultyComputerS.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Computer')">DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING</button></a>
<!--        <a href="Facultyhumanities.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Humanitis')">DEPARTMENT OF APPLIED SCIENCE AND HUMANITIS</button></a>-->
        <a href="Facultyelectronics.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Electronics')">DEPARTMENTS OF ELECTRONICS AND COMMUNICATION ENGINEERING</button></a>
        <a href="Facultymechanical.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Mechanical')">DEPARTMENT OF MECHANICAL ENGINEERING</button></a>
        <a href="Facultycivil.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Civil')">DEPARTMENT OF CIVIL ENGINEERING</button></a>
        <a href="Facultyelectrical.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Electrical')">DEPARTMENT OF ELECTRICAL ENGINEERING</button></a>
        
        <a href="Facultyinfotech.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Information')">DEPARTMENT OF INFORMATION TECHNOLOGY</button></a>
        <a href="Facultymca.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Mca')">DEPARTMENT OF MCA</button></a>
         <a href="Facultymsccs.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'msccs')">DEPARTMENT OF M.Sc.(CS)</button></a>
    </div>
    ...
    <div class="col-sm-5 content">
        ...
        <div id="Humanitis" class="tabcontent">
          ...
          <div id="msccs" class="tabcontent">
            <h3>DEPARTMENT OF Master Of Science (Computer Science)</h3><hr />
            <p>Master Of Science  is a set of related fields that encompass computer systems, software, programming languages and data and information processing and storage after Post Graduation..</p>
          </div>
        </div>
