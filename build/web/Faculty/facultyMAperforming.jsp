      ...
      <h1>Department of MA Performing Arts (Music)</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1>  MA Performing Arts (Music) Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master of Performing Arts Music (M.P.A.-Music)' and status='1' order by name ");
