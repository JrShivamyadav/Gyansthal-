...
.dropdown-content a:hover {background-color: #f57542;color:white}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="about.jsp"><span>About</span></a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="practices.jsp"><span>Practice</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="contact.jsp"><span>Contactus</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="review.jsp"><span>Feedback</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="quiz.jsp"><span>Quizes</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="dforem.jsp"><span>DiscussionForem</span></a>
        </li>
...
<div class="row">
  ...
  <div class="dropdown-content">
    ...
    <div class="file-row">
      <a target="_blank" href="UploadImg/<%=p.getFile() %>"><embed src="UploadImg/<%=p.getFile() %>" > </a>
    </div>
    <br>
    <span>Publish Date :<%=p.getPdate() %></span><br>
    <form action="Addcomment?id=<%=p.getId() %>" method="post">
...
<div class="col-lg-12 ">
  <form action="Addpost" class="modal-content"  enctype="multipart/form-data" method="post">
    <div class="container">
...
<label for="file"><b>Select File</b></label>
      ...
      <div class="clearfix">
        <input type="submit" class="signupbtn" name="s" value="Add Post">
      </div>
    </div>
  </form>
</div>
