            ...
            <div class="container-fluid">
				 ...
				 <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="AdminViewUserBlock.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">View Blocked</a></button>
				  ...
				  <table class="table table-responsive" style="background:white">
                          ...
                          <%
                              try{
                                ...
                                db.pstmt = db.con.prepareStatement("SELECT  * FROM user_register where status='1' ORDER BY date desc;");
                       ...
                       out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td>"
                               ...
                               +"<td><button><a href=Admindeleteuser.jsp?adm="+db.rst.getString(1)+"&rno="+db.rst.getString(2)+" >Delete</a> </button></td>"
                                +"<td><button ><a href=AdminBlockuser.jsp?adm="+db.rst.getString(1)+" >Block</a> </button></td>"
                               +"</tr>");
                                }
                              }catch(Exception e){
                                  e.printStackTrace();
