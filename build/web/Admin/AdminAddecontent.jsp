 ...
 <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
				  ...
				  <div class="col-md-6">
				  <h4 style="text-align:center;font-size:50px;font-weight:bold;text-shadow: 5px 0px 4px gray;color:red;font-family:Gabriola;margin-top:50px">Add Econtent</h4>
                                  <form action="../AdminAddecontent" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
				
                             Enter Year <input type="number" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />   
					...
					<br />
                              ...
                              Enter Branch      <select class="form-control" name="branch"style="border-bottom:2px solid red;background:none;font-size:15px">
  ...
  <option>Bachelor of Arts (B.A.)</option>
      ...
      <option>UG Diploma in German</option>
			...
			Mention Description<input type="text" required class="form-control" name="desc"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
                                    
<!--                           Mention Contents Type <input type="text" required class="form-control" name="ctype"style="border-bottom:2px solid maroon;background:none;font-size:15px"/>
					<br />    -->
