        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
				  ...
				  <form action="../AdminAddeNoews" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
                                   Enter Name   <input type="text"   class="form-control" name="name"style="border-bottom:2px solid maroon;background:none;font-size:15px"/>
                                   <br>
                                   Enter Email   <input type="text"  class="form-control" name="email"style="border-bottom:2px solid maroon;background:none;font-size:15px"/>
                                   <br>
