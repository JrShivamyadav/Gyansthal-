            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:red;text-shadow: 5px 0px 4px gray;font-size:35px;font-weight:bold;font-family: Gabriola">Syllabus </h4> </div>
                   ...
                   <th>View</th>
                    ...
                    <%
                      try{
                          ...
                          db.pstmt = db.con.prepareStatement("select * from data where ctype='Syllabus' and branch=? order by date desc");
                         db.pstmt.setString(1, branch);
                          ...
                          while(db.rst.next()){
                            out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td>"
                                    + "<td>"+db.rst.getString(4)+"</td><td>"+db.rst.getString(6)+"</td><td>"+db.rst.getString(7)+"</td><td>"
                                   + "<button ><a href=../pdf/"+db.rst.getString(6)+">View</a></button></td></tr>");
                          }
