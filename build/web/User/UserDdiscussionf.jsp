  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
            <a class="nav-link"  href="userindex.jsp"><span>Home</span></a>
        </li>
          <li class="nav-item">
            <a class="nav-link"  href="useraboutus.jsp"><span>AboutUs</span></a>
        </li>
      ...
      <a class="dropdown-item" href="userengineering.jsp">Faculty of Engineering</a>
            ...
            <a class="dropdown-item" href="Ulaw.jsp">Faculty of Law</a>
              <a class="dropdown-item" href="Ueducation.jsp">Faculty of PhysicalEducation,Sports,Yoga</a>
        ...
        <li class="nav-item">
          <a class="nav-link" href="userpractices.jsp"><span>Practice</span></a>
        </li>
        
      
        <li class="nav-item">
          <a class="nav-link" href="userquiz.jsp"><span>Quizes</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="UserContactus.jsp"><span>Contactus</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="UserDdiscussionf.jsp"><span>Discussion</span></a>
        </li>
         <li>
             <a class="profile-pic" href="UserDashboard.jsp"> <img src="../img/login.png"  alt="user-img" width="36" class="img-circle"><b class="hidden-xs" style="float:left; color:black;font-size:25px;font-family: Gabriola">User<span></span></b></a>
       </li>
...
<div class="row">
  ...
  <div class="dropdown-content">
    <a href="UserDEditpost.jsp?id=<%=p.getId() %>">Edit</a>
    <a href="UserDdeletepost.jsp?id=<%=p.getId() %>">Delete</a>
    ...
    <form action="UserDAddComment.jsp?id=<%=p.getId() %>" method="post">
...
<div class="col-lg-12 ">
  <form action="../UAddpostservlet" class="modal-content"  enctype="multipart/form-data" method="post">
    <div class="container">
