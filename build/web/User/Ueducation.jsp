...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="UEducationBpes.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'BPES')">DEPARTMENT OF BPES</button></a>
        <a href="UEducationBped.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'BPED')">DEPARTMENT OF BPED</button></a>
         <a href="UEducationMped.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'MPED')">DEPARTMENT OF MPED</button></a>
          <a href="UEducationPghealthFitness.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'pghelthfitness')">DEPARTMENT OF DIPLOMA IN HEALTH AND FITNESS MANAGEMENT</button></a>
           <a href="UEducationDstrength.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'dstrength')">DEPARTMENT OF DIPLOMA IN STRENGTH AND CONDITIONING</button></a>
            <a href="UEducationMyoga.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Myoga')">DEPARTMENT OF MASTER OF YOGA</button></a>
             <a href="UEducationPgdyoga.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'pgdyoga')">DEPARTMENT OF PG DIPLOMA IN YOGA AND ALTERNATIVE THERAPY</button></a>
