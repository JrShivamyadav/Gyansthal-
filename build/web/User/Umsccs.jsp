  ...
  <link href="../JSPcode/ComputerS.css" rel="stylesheet" />
          ...
          <div class="col-sm-10 main">
            ...
            <div class="row a2">
              ...
              <div class="col-sm-1">
                <a href="Uengineering.jsp"><i class="fa fa-arrow-left" aria-hidden="true">&nbsp;Back</i></a>
              </div>
    ...
    <div class="row">
      <h1>Department of Msc Computer Science</h1>
       <div class="container CSEcontent">
        <div class="col-sm-6 ">
          <p>The Department of  Msc CS offers PG Diploma programme, and the number of students intake is 60 every year. The success rate at examinations and Respectively and employment are fairly impressive in the present scenario. The thrust areas of the Department included Computer Networking, Fault Tolerance, Software Engineering, Database, Computer Architecture. The major focus of the Department in teaching and research has been on Networking, Database and Software Engineering. The Department has Computers and various licensed software?s. There is a plan of action to achieve the aims 
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. Computer Science' and status='1' order by name ");
