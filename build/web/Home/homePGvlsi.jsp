      ...
      <h1>Department of PG Diploma In VLSI Design </h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> PG Diploma In VLSI Design  Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='P.G. Diploma in V.L.S.I. Design' and status='1' order by name ");
