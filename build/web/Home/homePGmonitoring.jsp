      ...
      <h1>Department of PG Diploma In Environmental Monitoring and Simulation</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> PG Diploma In Environmental Monitoring and Simulation Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Advanced P.G. Diploma in Environmental Monitoring & Simulation' and status='1' order by name ");
