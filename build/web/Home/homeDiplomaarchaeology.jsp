      ...
      <h1>Department of Diploma in Archaeology</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> Diploma in Archaeology Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Diploma in Archaeology' and status='1' order by name ");
