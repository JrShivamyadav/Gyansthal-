<%@include file="MProgramStruct.jsp" %>
    ...
    <div class="row">
      <h1>Department of PG Diploma In BioInformatics</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> PG Diploma In BioInformatics Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Advanced P.G. Diploma in Bioinformatics' and status='1' order by name ");
