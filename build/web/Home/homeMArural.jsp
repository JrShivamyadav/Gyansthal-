      ...
      <h1>Department of MA Economics And Rural Development</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA Economics And Rural Development Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.A. Economics and Rural Development' and status='1' order by name ");
