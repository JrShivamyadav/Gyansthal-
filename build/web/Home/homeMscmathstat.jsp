      ...
      <h1>Department of MSc. Math(Statics)</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MSc. Math(Statics) Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. Mathematics (Statistics)' and status='1' order by name ");
