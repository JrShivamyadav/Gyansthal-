     ...
     <h1>Department of Master Of Arts in Drawing and Painting </h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1>  MA (Drawing and Painting) Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.A. in Drawing & Painting' and status='1' order by name ");
