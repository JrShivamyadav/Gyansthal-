      ...
      <h1>Department of PG Diploma In Fashion Designing</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> PG Diploma In PG Diploma In Fashion Designing Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='P.G. Diploma in Fashion Designing' and status='1' order by name ");
