<%@include file="MProgramStruct.jsp" %>
    ...
    <div class="row">
      <h1>Department of UG Diploma In German</h1>
       <div class="container CSEcontent">
        <div class="col-sm-6 ">
          <p>The Department of UG Diploma In German offers Graduation Programme, and the number of students intake is 60 every year. The success rate at examinations and Respectively and employment are fairly impressive in the present scenario. The thrust areas of the Department included Computer Networking, Fault Tolerance, Software Engineering, Database, Computer Architecture. The major focus of the Department in teaching and research has been on Networking, Database and Software Engineering. The Department has Computers and various licensed software?s. There is a plan of action to achieve the aims 
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> UG Diploma In German Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='UG Diploma in German' and status='1' order by name ");
