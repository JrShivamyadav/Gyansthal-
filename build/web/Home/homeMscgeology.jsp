       ...
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. in Geology' and status='1' order by name ");
