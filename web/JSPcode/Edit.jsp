...
<div class="row AddPostheading">
   <div class="col-lg-12 ">
<i class="fa-solid fa-plus">&nbsp;&nbsp;Edit Posts</i></div></div>
<div class="col-lg-12 ">
<%
int id=Integer.parseInt(request.getParameter("id"));
Posts p=new PostDao().getPostbyId(id);
%>
  <form action="Editpost" class="modal-content"  enctype="multipart/form-data" method="post">
    <div class="container">
      <label for="text"><b><%=p.getId() %></b></label>
...
<label for="file"><b>Select File</b></label>
      <input type="file" placeholder="Enter file" name="file"  accept=".png, .jpg, .jpeg,.mp4, .webm, .ogg"  value="<%=p.getFile() %>" >

      <label for="description"><b>Post Description</b></label>
      <textarea placeholder="Enter Post Description" name="dstrn" required><%=p.getDescription() %></textarea>
      
      <div class="clearfix">
        <input type="submit" class="signupbtn" name="s" value="Edit Post">
      </div>
    </div>
  </form>
</div>
