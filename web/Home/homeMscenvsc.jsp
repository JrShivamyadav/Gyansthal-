<%@include file="MProgramStruct.jsp" %>
          ...
          <div class="col-sm-10 main">
            ...
            <div class="row a2">
              ...
              <div class="col-sm-1">
                <a href="Homescience.jsp"><i class="fa fa-arrow-left" aria-hidden="true">&nbsp;Back</i></a>
              </div>
      ...
      <h1>Department of MSc. Environmental Science</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MSc. Environmental Science Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. Environmental Science' and status='1' order by name ");
