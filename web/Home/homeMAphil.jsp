      ...
      <h1>Department of MA Philosophy And Religion</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1>  MA Philosophy And Religion Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.A. in Philosophy and Religion' and status='1' order by name ");
