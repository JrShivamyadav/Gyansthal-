      ...
      <h1>Department of MA Mass Communication And Journalism</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA Mass Communication And Journalism Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.A. in Mass Communication & Journalism (M.C.J.)' and status='1' order by name ");
