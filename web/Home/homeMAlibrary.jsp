      ...
      <h1>Department of MA Library and Information Science</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA Library and Information Science Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master in Library and Information Science (M.Lib.I.Sc.)' and status='1' order by name ");
