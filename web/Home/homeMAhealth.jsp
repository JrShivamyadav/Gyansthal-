      ...
      <h1>Department of Master Of Arts Public Health</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA Public Health Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master of Public Health (M.P.H.)' and status='1' order by name ");
