...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="homeEducationBpes.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'BPES')">DEPARTMENT OF BPES</button></a>
        <a href="homeEducationBped.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'BPED')">DEPARTMENT OF BPED</button></a>
         <a href="homeEducationMped.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'MPED')">DEPARTMENT OF MPED</button></a>
          <a href="homeEducationPghealthFitness.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'pghelthfitness')">DEPARTMENT OF DIPLOMA IN HEALTH AND FITNESS MANAGEMENT</button></a>
           <a href="homeEducationDstrength.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'dstrength')">DEPARTMENT OF DIPLOMA IN STRENGTH AND CONDITIONING</button></a>
            <a href="homeEducationMyoga.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Myoga')">DEPARTMENT OF MASTER OF YOGA</button></a>
             <a href="homeEducationPgdyoga.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'pgdyoga')">DEPARTMENT OF PG DIPLOMA IN YOGA AND ALTERNATIVE THERAPY</button></a>
