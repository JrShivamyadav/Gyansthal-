      ...
      <h1>Department of Master Of Arts FineArt-Painting</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA FineArt-Painting Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master of Fine Arts-Painting (MFA-Painting)' and status='1' order by name ");
