      ...
      <h1>Department of MSc. Biotechnology</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1>  MSc. Biotechnology Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. Biotechnology' and status='1' order by name ");
