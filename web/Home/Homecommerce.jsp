...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="homeBba.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bba')">DEPARTMENT OF BACHELOR OF BUSINESS ADMINISTRATION </button></a>
      <a href="homeBca.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bca')">DEPARTMENT OF BACHELOR OF COMPUTER APPLICATION </button></a>
      <a href="homeBcom.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bcom')">DEPARTMENT OF BACHELOR OF COMMERCE </button></a>
      
      <a href="homeMba.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mba')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION </button></a>
      <a href="homeMbaf.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbaf')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN FINANCE & CONTROL</button></a>
      <a href="homeMbaagri.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbaag')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN AGRI. BUSINESS </button></a>
      <a href="homeMbahospitality.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbah')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN HOSPITALITY MANAGEMENT</button></a>
      
      <a href="homeMbatourism.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbat')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN TOURISM MANAGEMENT </button></a>
