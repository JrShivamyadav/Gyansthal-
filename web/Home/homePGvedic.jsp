      ...
      <h1>Department of Advance Certificate course in Vedic Mathematics </h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1>  Advance Certificate course in Vedic Mathematics  Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Advanced Certificate Course in Vedic Mathematics' and status='1' order by name ");
