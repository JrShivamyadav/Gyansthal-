...
<div class="row ">
        ...
        <div class="col-sm-8 crshead">
            <div class="row text-center">
                <span>Departments Of Engineering</span>
            </div>
        </div>
        <div class="col-sm-2"></div>
    </div>
    ...
    <div class="col-sm-5 tabs">
      <a href="userComputerS.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Computer')">DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING</button></a>
<!--        <a href="userart.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Humanitis')">DEPARTMENT OF APPLIED SCIENCE AND HUMANITIS</button></a>-->
       <a href="Uelectronics.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Electronics')">DEPARTMENTS OF ELECTRONICS AND COMMUNICATION ENGINEERING</button></a>
      
        <a href="Umechanical.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Mechanical')">DEPARTMENT OF MECHANICAL ENGINEERING</button></a>
        <a href="Ucivil.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Civil')">DEPARTMENT OF CIVIL ENGINEERING</button></a>
        <a href="Uelectrical.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Electrical')">DEPARTMENT OF ELECTRICAL ENGINEERING</button></a>
        <a href="Umca.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Mca')">DEPARTMENT OF MCA</button></a>
        <a href="Uinfotech.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'Information')">DEPARTMENT OF INFORMATION TECHNOLOGY</button></a>
    </div>

    <div class="col-sm-5 content">
        <div class="container-fluid">
          <div id="Computer" class="tabcontent">
            <h3>DEPARTMENT OF COMPUTER SCIENCE</h3><hr />
