      ...
      <h1>Department of MA Tourism And Travel Management</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> MA Tourism And Travel Management Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='Master of Tourism and Travel Management (M.T.T.M.)' and status='1' order by name ");
