            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:red;text-shadow: 5px 0px 4px gray;font-size:35px;font-weight:bold;font-family: Gabriola">PYQs</h4> </div>
                   ...
                   <th>View</th>
                    ...
                    <%
                      ...
                      try{
                          ...
                          db.pstmt = db.con.prepareStatement("select * from data where ctype='Pyq' and branch=? order by date desc");
