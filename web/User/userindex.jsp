...
<%
    try{
     ...
     db1.pstmt = db1.con.prepareStatement("select rno,email,name,branch from user_register where adm=? ");
     ...
     if(db1.rst.next()){
         ...
         session.setAttribute("userbranch", db1.rst.getString(4));
...
<div class="row" style="margin-top:100px">
    <!------------------------------------------------------start of serives ---------------------------------------------------------------->
        ...
        <div class="row container" >
            ...
            <div class="col-sm-3 box" >
               ...
               <div class="content" >
              <a href="UserContactus.jsp"><h3 >Contact</h3></a>
            ...
            <div class="col-sm-3 box">
                <div class="icon">
                   ...
                   <div class="content" >
                  <a href="userquiz.jsp"><h3 >Quizes</h3></a>
    ...
    <div class="col-sm-3 box" >
       ...
       <div class="content" >
      <a href="userpractices.jsp"><h3 >Practice</h3></a>
    ...
    <div class="row container" >
        ...
        <div class="col-sm-3 box" >
           ...
           <div class="content" >
          <a href="UserviewPlacement.jsp"><h3 >Placement</h3></a>
        ...
        <div class="col-sm-3 box">
            <div class="icon">
               ...
               <div class="content" >
                   <a href="UserDdiscussionf.jsp"><h3 >discussion</h3></a>
