     ...
     <div class="container-fluid">
               <div class="row bg-title" style="border-bottom:2px solid black">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:red;font-size:35px;font-weight:bold;font-family: Gabriola;text-shadow: 5px 0px 4px gray;">ADD PROFILE</h4> </div>
                ...
                <div class="row">
				  ...
				  <h4 style="text-align:center;font-size:50px;font-weight:bold;color:red;font-family:Gabriola;margin-top:50px">Add Details</h4>
                                  <form action="../UserAddProfile" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
				
                       
                                        
                        Enter Name <input type="Text" required class="form-control" name="year"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />  
                               Enter Department <select  required class="form-control" name="year" style="border-bottom:2px solid red;background:none;font-size:15px" >
      ...
      <option>UG Diploma in German</option>
					...
					<br />
                       Enter Date of Birth	<input type="text" required class="form-control" name="dob" placeholder="yyyy-mm-dd" style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />                            
			Enter Mobile No.<input type="number" required class="form-control" name="desc"style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />                         
                                    				
			Upload profile Pic	<input type="file" required class="form-control" name="file" style="border-bottom:2px solid red;background:none;font-size:15px"/>
					<br />
