    ...
    <div  class="top">
        ...
        <div class="row content">
          ...
          <div class="col-sm-2 sidenav">
              <a href="#"><img src="../img/lohialogo.jpg" style="height:80px; width:80px;border-radius:45px;"/></a>
            <hr/>
              ...
              <a href="UserviewPlacement.jsp"><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;&nbsp; Placement</a>
