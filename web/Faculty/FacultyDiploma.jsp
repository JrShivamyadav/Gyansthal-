...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="facultyDiplomafrench.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'french')">DEPARTMENT OF  UG DIPLOMA IN FRENCH </button></a>
      <a href="facultyDiplomagerman.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'german')">DEPARTMENT OF  UG DIPLOMA IN GERMAN </button></a>
      <a href="facultyDiplomaarchaeology.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'archaeology')">DEPARTMENT OF DIPLOMA IN ARCHAEOLOGY </button></a>
      
      <a href="facultyDiplomaartappreciation.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'artappreciation')">DEPARTMENT OF CERTIFICATE COURSE IN ART APPRECIATION</button></a>
      <a href="facultyDiplomafermentation.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'fermentation')">DEPARTMENT OF CERTIFICATE COURSE IN FERMENTATION TECHNOLOGY</button></a>
      <a href="facultyDiplomawater.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'water')">DEPARTMENT OF CERTIFICATE COURSE IN SOIL AND WATER TESTING </button></a>
      <a href="facultyDiplomaenglish.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'english')">DEPARTMENT OF CERTIFICATE OF PROFICIENCY IN ENGLISH COMMUNICATION</button></a>
