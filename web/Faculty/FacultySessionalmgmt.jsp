<%@include file="FacultyDashStruct.jsp" %>
            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-10 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyAddsessional.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Add </a></button>
                         <button type="submit" style="background: red;height: 40px;float: left;margin-top: 5px; width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyUpdateSessional.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Update/Delete</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                   ...
                   <table class="table table-responsive" style="background:white">
                    ...
                    <%
                         ...
                         db.pstmt.setString(3,subject); 
                          ...
                          while(db.rst.next()){
                            ...
                            out.println("<tr><td>"+db.rst.getString(4)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td>"
                                    ...
                                    + "<button><a href=Facultydeletesessional.jsp?sub="+db.rst.getString(5)+",rno="+db.rst.getString(6)+",date="+db.rst.getString(9)+" >Delete</a> </button></td></tr>");
                          } 
                      }
                        ...
                        if(request.getParameter("opr2")!= null){
                          ...
                          DB.DBConnection db = new DB.DBConnection();
                          db.pstmt = db.con.prepareStatement("select * from sessional where session=? and rollnumber=? order by date");
                          ...
                          db.rst = db.pstmt.executeQuery();
                           ...
                           while(db.rst.next()){
                            ...
                            out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td>"
                                    ...
                                    + "<button><a href=Facultydeletesessional.jsp?desc="+db.rst.getString(4)+",date="+db.rst.getString(8)+" >Delete</a> </button></td></tr>");
                          }
                        }  
                      }catch(Exception e){
                          e.printStackTrace();
 ...
 +" <option>UG Diploma in German</option>"
                      ...
                      +"      <select name=subject required class='ip1' style='border-bottom:2px solid red;background:none;'>"
                       ...
                       +"         <option>DBMS</option>"
                       +"     </select><br>"
                      +"      <input type=text name=rno required class='ip1' style='border-bottom:2px solid red;background:none;'  placeholder='Enter Roll No...' ><br>"
                   
                                    + " <input type=submit value='Search By Subject' name=opr1 class=ip2 >"
                     +"   <input type=submit value='Search By Rno' name=opr2 class=ip3 >"
                     +"   </form>" );
                        }
