...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="facultyPharmaDiploma.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'dph')">DEPARTMENT OF DIPLOMA IN PHRAMACY</button></a>
        <a href="facultyPharmaBachelor.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bph')">DEPARTMENT OF BACHELOR IN PHARMACY</button></a>
        <a href="facultyPharmaBlateral.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bphl')">DEPARTMENT OF BACHELOR IN PHARMACY  (LATERAL ENTRY)</button></a>
