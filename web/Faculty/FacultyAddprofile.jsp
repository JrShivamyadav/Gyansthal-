     ...
     <div class="container-fluid">
               <div class="row bg-title" style="border-bottom:2px solid black">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="color:red;text-shadow: 5px 0px 4px gray;font-size:35px;font-weight:bold;font-family: Gabriola">ADD PROFILE</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="FacultyViewProfile.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">View Profile</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
				  ...
				  <div class="col-md-6">
				  <h4 style="text-align:center;font-size:50px;font-weight:bold;color:red;font-family:Gabriola;margin-top:50px">Add Details</h4>
                                  <form action="../FacultyAddProfile" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
				
                       Salutation <select required class="form-control" name="sal" style="border-bottom:2px solid red;background:none;font-size:25px">
                           <option>Mr.</option>
                           <option>Mr.</option>
                           <option>Mrs.</option>
                           <option>Miss.</option>
					...
					<br />  
                        ...
                        Enter Name <input type="Text" required class="form-control" name="name" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />  
                               Select Branch <select  required class="form-control" name="dept" style="border-bottom:2px solid red;background:none;font-size:25px">
      ...
      <option>UG Diploma in German</option>
					...
					<br />          
                        ...
                        <input type="hidden"  class="form-control" name="email"  value="<%=email %>" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />
                                                    
			Enter Mobile No.<input type="number" required class="form-control" name="mob" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />
                                        
                         
                                      
                        Enter Specialization<input type="Text" required class="form-control" name="spec" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />
                         Enter Designation <select required class="form-control" name="post" style="border-bottom:2px solid red;background:none;font-size:25px">
			...
			Upload profile Pic	<input type="file" required class="form-control" name="file" style="border-bottom:2px solid red;background:none;font-size:20px"/>
					<br />
			Enter Qualification<input type="Text" required class="form-control" name="qual" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />	
                        Enter Area Of Interest<input type="Text" required class="form-control" name="area" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />               
