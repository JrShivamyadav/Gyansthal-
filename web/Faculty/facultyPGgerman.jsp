French<%@include file="FProgramStruct.jsp" %>
          <!---------------- content------------------------------->
      ...
      <h1>Department of PG Diploma In German</h1>
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <h1> PG Diploma In PG Diploma In German Faculty</h1>
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='PG Diploma in German' and status='1' order by name ");
