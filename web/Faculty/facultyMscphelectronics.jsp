<%@include file="FProgramStruct.jsp" %>
          ...
          <div class="col-sm-10 main">
            ...
            <div class="row a2">
              ...
              <div class="col-sm-1">
                <a href="Facultyscience.jsp"><i class="fa fa-arrow-left" aria-hidden="true">&nbsp;Back</i></a>
              </div>
       ...
       <div class="container CSEcontent">
        ...
        <div class=" col-sm-5 CSEimg">
         ...
         <div class="row Faculty"> 
          ...
          db.pstmt = db.con.prepareStatement("select * from faculty_detail where branch='M.Sc. Physics (Electronics)M.Sc. Physics (Electronics)' and status='1' order by name ");
