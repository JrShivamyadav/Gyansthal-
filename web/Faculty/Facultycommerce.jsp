...
<div class="row ">
    ...
    <div class="col-sm-5 tabs">
      <a href="facultyBba.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bba')">DEPARTMENT OF BACHELOR OF BUSINESS ADMINISTRATION </button></a>
      <a href="facultyBca.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bca')">DEPARTMENT OF BACHELOR OF COMPUTER APPLICATION </button></a>
      <a href="facultyBcom.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'bcom')">DEPARTMENT OF BACHELOR OF COMMERCE </button></a>
      
      <a href="facultyMba.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mba')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION </button></a>
      <a href="facultyMbaf.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbaf')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN FINANCE & CONTROL</button></a>
      <a href="facultyMbaagri.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbaag')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN AGRI. BUSINESS </button></a>
      <a href="facultyMbahospitality.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbah')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN HOSPITALITY MANAGEMENT</button></a>
      
      <a href="facultyMbatourism.jsp"><button class="tablinks" onmouseover="openDepartment(event, 'mbat')">DEPARTMENT OF MASTER OF BUSINESS ADMINISTRATION IN TOURISM MANAGEMENT </button></a>
