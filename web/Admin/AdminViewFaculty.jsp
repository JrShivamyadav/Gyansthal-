            ...
            <div class="container-fluid">
                ...
                <!-- .row -->
				 <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="AdminViewFacultyBlock.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">View Block</a></button>
                    <!-- /.col-lg-12 -->
                </div>
				 ...
				 <div class="col-md-12">
				  <table class="table table-responsive" style="background:white">
                                      ...
                                      <tr><th>Email </th>  <th>Aadhar</th><th>Date Of Birth</th>
                                          <th>Name</th><th>Post</th><th>Contact</th><th>date </th><th>Delete</th><th>Block</th>
                                      </tr>
                          <%
                              try{
                       ...
                       out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td>"
                               ...
                               + "<td>"+db.rst.getString(6)+"</td><td>"+db.rst.getString(7)+"</td>"
                                ...
                                +"<td><button ><a href=AdminBlockfaculty.jsp?email="+db.rst.getString(1)+" >Block</a> </button></td>"
