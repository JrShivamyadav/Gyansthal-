<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    try{
        ...
        Iterator<Row> iterator = firstSheet.iterator();
         out.println("<button><a href='AdminInsertExcel.jsp' >Back</a></button><br><br><br><br>");
        ...
        PreparedStatement st=con.prepareStatement("UPDATE sessional SET  sessional2=?, date = curdate() WHERE rollno = ?");
        for(int i=0;i<=cellArrayListHolder.size();i++)
        {  
            
                rowarrylist=(ArrayList)cellArrayListHolder.get(i);
                st.setString(1,rowarrylist.get(5).toString());
            st.setString(2,rowarrylist.get(3).toString());
           
            System.out.println("Roll Number :"+rowarrylist.get(3).toString());
            System.out.println("Sessional :"+rowarrylist.get(5).toString());
            System.out.println("Subject :"+rowarrylist.get(4).toString());
