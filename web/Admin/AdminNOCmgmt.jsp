                ...
                <div class="row" style="margin-top:40px">
				 <div class="col-md-12">
				  <table class="table table-responsive" style="background:white">
                                      ...
                                      <tr><th>Roll No</th> <th>Ref No</th> <th>Name</th><th>F.Name</th><th>Address</th><th>Inst.Fine </th>
                                          <th>Lib.Fine </th><th>Lab.Fine </th><th>Date </th>
                                      <th>Delete</th> </tr>
                          <%
                              try{
                                DB.DBConnection db = new DB.DBConnection();
                                db.pstmt = db.con.prepareStatement("SELECT  * FROM noc ORDER BY date desc");
                       ...
                       out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td>"
                               ...
                               + "<td>"+db.rst.getString(9)+"</td><td><button><a href=Admindeletenoc.jsp?ref="+db.rst.getString(2)+">Delete</a> </button></td></tr>");
                                }
                              }catch(Exception e){
                                  e.printStackTrace();
                              }
