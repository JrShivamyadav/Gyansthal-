     ...
     <div class="container-fluid">
               <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="AdminViewProfile.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">View Profile</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
				  ...
				  <h4 style="text-align:center;font-size:50px;font-weight:bold;color:red;font-family:Gabriola;margin-top:50px">Add Details</h4>
                                  <form action="../AdminAddProfile" method="post" enctype="multipart/form-data">
				  <div class="col-md-12" style="font-size:25px;font-weight:bold;margin-top:60px;font-family:Gabriola">
					...
					<br />  
                               Enter Department <select  required class="form-control" name="dept" style="border-bottom:2px solid red;background:none;font-size:25px">
  ...
  <option>Bachelor of Arts (B.A.)</option>
      ...
      <option>UG Diploma in German</option>
					...
					<br />          
                        ...
                        Enter Email <input type="hidden"  class="form-control" name="email"  value="<%=email %>" style="border-bottom:2px solid red;background:none;font-size:25px"/>
					<br />
