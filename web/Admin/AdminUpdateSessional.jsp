 <%@include file="AdminDashStruct.jsp" %>
        <div id="page-wrapper">
           ...
           <%
               ...
               db.pstmt = db.con.prepareStatement("select * from sessional where rollno=?");
                                   ...
                                   try{
                                     if(request.getParameter("rno")!= null){
                                       ...
                                       if(request.getParameter("opr1")!= null){
                                        ...
                                        DB.DBConnection db = new DB.DBConnection();
                                        db.pstmt = db.con.prepareStatement("update sessional set branch=?,session=?,sem=?,subject=?,sessional1=?,sessional2=?,sessional3=?,date=curdate() where rollno=?");
