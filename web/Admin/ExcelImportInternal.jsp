<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    try{
        ...
        PreparedStatement st=con.prepareStatement("INSERT INTO  internalmarks VALUES (?,?,?,?,?,?,?,?,?,?,?,curdate())");
        ...
        {  
            ...
            st.setString(10,rowarrylist.get(9).toString());
            st.setString(11,rowarrylist.get(10).toString());
                       st.executeUpdate(); 
            } 
