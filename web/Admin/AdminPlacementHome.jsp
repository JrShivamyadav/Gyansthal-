                      ...
                      db.pstmt.setString(1, branchh);
                            ...
                            db.rst = db.pstmt.executeQuery();
                              ...
                              out.println("<table class='table table-responsive' style='background:white;' max-width=750 bgcolor=cyan cellspacing=30  cellpadding=50 border=2>"
                                    ...
                                    + "<th>High<br>Edu.</th><th>Linkedin</th><th>Offer<br>Letter</th><th>Delete</th></tr>");
                            ...
                            while (db.rst.next()) {
                               ...
                               + "<td>" + db.rst.getString(11) + "</td><td>" + db.rst.getString(13) + "</td><td><a target='ind' href='"+db.rst.getString(9) + "'>Visit</a></td><td><a class='btnview' href='../NOC/" + db.rst.getString(14)+ "'>View</a></td>"
                                          + "<td><button><a href=Admindeleteplacement.jsp?date="+db.rst.getString(15)+"&rno="+db.rst.getString(1)+">Delete</a> </button></td></tr>");                    
 ...
 +" <option>UG Diploma in German</option>"
        ...
        <div class="container">
            <%
                if(request.getParameter("opr1")!= null){
                    %>
                  <%@include file="AdminPlacementyear.jsp" %>
               <% }
                if(request.getParameter("opr2")!= null){
                    %>
                  <%@include file="AdminPlacementBranch.jsp" %>
                  <% } 
                if(request.getParameter("opr3")!= null){
                    %>
                  <%@include file="AdminPlacementTopten.jsp" %>
                <% }
                  %>
