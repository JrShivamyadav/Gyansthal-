<%@include file="AdminDashStruct.jsp" %>
            ...
            <div class="container-fluid">
                <div class="row bg-title" style="border-bottom:2px solid black">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 400px;box-shadow: 5px 0px 4px gray;"><a href="AdminAddInternal.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Add Marks</a></button>
                         <button type="submit" style="background: red;height: 40px;width: 150px;border-radius: 10px;margin-left: 580px;box-shadow: 5px 0px 4px gray;"><a href="AdminUpdateInternal.jsp" style="color: white;text-decoration: none;font-size: 15px;font-weight: bold;">Update/Delete</a></button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        if(request.getParameter("opr2")!= null){
                          ...
                          db.rst = db.pstmt.executeQuery();
                           ...
                           String usubj = java.net.URLEncoder.encode(subj, "UTF-8");
                            ...
                            + "<button><a href=Admindeleteinternal.jsp?rollno="+db.rst.getString(1)+",&subject="+usubj+"&date="+db.rst.getString(12)+">Delete</a> </button></td></tr>");
 ...
 +" <option>UG Diploma in German</option>"
                          ...
                          +"  </select>"
                            ...
                            +"  <select name=sem required class=ip1>"
